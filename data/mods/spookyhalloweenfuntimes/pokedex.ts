...
//Oh yeah, also I didn't put numbers on anything haha um go ahead and fix tha if you need
	...
	fealine: {
		name: "Fealine",
		types: ["Ghost"],
		baseStats: {hp: 99, atk: 113, def: 70, spa: 75, spd: 85, spe: 67},
	...
	swirlixvariant: {
		...
		movepoolDeletions: ["calmmind", "aromatherapy", "bellydrum", "cottonguard", "dazzlinggleam", "drainingkiss", "fairywind", "mistyexplosion", "playrough"],
	...
	*/
	...
	snorunt: {
		inherit: true,
		evos: ["Glalie", "Froslass", "Froslas-Theater"],
	},
	froslass: {
		inherit: true,
	...
	parasect: {
		inherit: true,
		evos: ["Parascelium"],
		movepoolAdditions: ["myceliate"],//Like Hyper Drill and Twin Beam; evolves via knowing a new move given in a new gen.
	},
	parascelium: {
		name: "Parascelium",
		copyData: "Parasect",
